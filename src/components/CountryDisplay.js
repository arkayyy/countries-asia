            ...
            <div className="countriesList">
                {countriesAsia.countries[0]?countriesAsia.countries.map((country)=>(
                    ...
                    <div className="countryBox" >
                        ...
                        <div><h2 style={{display:"inline"}}>BORDERS:</h2> <p style={{fontSize:"25px"}}><ul style={{listStyle:"none",display:"flex" , flexWrap:"wrap", justifyContent:"center"}}>{country.borders.map((border)=>(<li style={{display:"inline", margin:"4px"}}>{border}</li>))}</ul></p></div>
                        <div><h2>LANGUAGES:</h2> <p style={{fontSize:"25px"}}><ul style={{listStyle:"none"}}>{country.languages.map((lang)=>(<li style={{display:"inline", margin:"4px"}}>{lang.name}</li>))}</ul></p></div>
                        </div>
